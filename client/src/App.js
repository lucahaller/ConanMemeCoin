...
function App() {
  ...
  return (
    <div className=" bg-gradient-to-r from-stone-300 to-stone-400">
      <Navbar />
      <section
      ...
      >
        <div
          className="w-full xl:h-[1000px]  flex-col bg-marroncito items-center border-8 rounded-3xl p-0 shadow-lg flex bg-cover"
        ...
        >
          ...
          <div className="flex flex-row gap-10 ">
            <button className="px-10 py-3 border-4 text-3xl border-black shadow-[3px_3px_0px_#000] text-marronclaro hover:text-marroncito font-bold bg-marroncito transition-all duration-300 cursor-pointer hover:translate-x-[1.5px] hover:translate-y-[1.5px] hover:shadow-[1.5px_1.5px_0px_#000] hover:bg-marronclaro active:translate-x-[3px] active:translate-y-[3px] active:shadow-none">
              Chart
            </button>
            <button className="px-7 py-3 border-4 text-3xl border-black shadow-[3px_3px_0px_#000] hover:text-marronclaro font-bold bg-marronclaro transition-all duration-300 cursor-pointer hover:translate-x-[1.5px] hover:translate-y-[1.5px] hover:shadow-[1.5px_1.5px_0px_#000] hover:bg-marronhover active:translate-x-[3px] active:translate-y-[3px] active:shadow-none">
              Join us
            </button>
          </div>
        </div>
      ...
      <section className="min-h-full flex justify-center items-center py-20">
        <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center  justify-center lg:items-start gap-10">
          {/* Contenido a la izquierda */}
          <div className="lg:w-2/3 text-center lg:text-left">
            <h2 className="text-7xl font-lucky text-stone-800">
              About the history of{" "}
              <span className="text-red-600 inline-block" data-aos="flip-up">
                CONAN
              </span>
            </h2>
          ...
          <div className="lg:w-1/2 flex justify-center " data-aos="fade-left">
            <img
              ...
              className="w-80 h-auto rotate-6 shadow-lg rounded-lg"
            />
          </div>
        </div>
      </section>
