    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <div
            className="flex flex-row gap-10  md:text-3xl text-xl"
            data-aos="flip-up"
          >
        ...
        <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center  p-4 md:p-4 lg:p-0 justify-center lg:items-start gap-10">
          ...
          <div className="lg:w-2/3 text-center lg:text-left">
            <h2 className="text-7xl font-lucky text-stone-200">
              ...
              <span className="text-violet-600 inline-block" data-aos="flip-up">
                CONAN
              </span>
            </h2>
            ...
            <div
              className="flex flex-row gap-10 mt-10  md:text-3xl text-xl"
              data-aos="flip-up"
            >
              ...
              <button className="px-7 py-3 border-4 text-gray-900 border-gray-100 shadow-[3px_3px_0px_#fff] hover:text-gray-800 font-bold bg-violetita transition-all duration-300 cursor-pointer hover:translate-x-[1.5px] hover:translate-y-[1.5px] hover:shadow-[1.5px_1.5px_0px_#fff] hover:bg-pink-500 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none">
                See a video
              </button>
            </div>
          </div>
